...
//{
  ...
  public class OSC
  {
    ...
    public readonly int inPort  = 6969;
    public readonly string outIP = "127.0.0.1";
    public readonly int outPort  = 6161;
    ...
    public OSC(int inPort = 6969, string outIP = "127.0.0.1", int outPort  = 6161) {
    this.inPort = inPort;
    this.outIP = outIP;
