Shader "MotionSurfaceShader"
{
    Properties
    {
        ...
        _MotionVectorAlphaCutoff("Float", Float) = 1
    ...
    SubShader
    {
        ...
        SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
        {
            ...
            UnityTexture2D _Property_a4fcc978e0924c1083eee80883b8ecaf_Out_0 = UnityBuildTexture2DStructNoScale(_Texture2D);
            float4 _SampleTexture2D_4268274b97974a278c5368845b799a90_RGBA_0 = SAMPLE_TEXTURE2D(_Property_a4fcc978e0924c1083eee80883b8ecaf_Out_0.tex, _Property_a4fcc978e0924c1083eee80883b8ecaf_Out_0.samplerstate, _Property_a4fcc978e0924c1083eee80883b8ecaf_Out_0.GetTransformedUV(IN.uv0.xy));
            float _SampleTexture2D_4268274b97974a278c5368845b799a90_R_4 = _SampleTexture2D_4268274b97974a278c5368845b799a90_RGBA_0.r;
            float _SampleTexture2D_4268274b97974a278c5368845b799a90_G_5 = _SampleTexture2D_4268274b97974a278c5368845b799a90_RGBA_0.g;
            float _SampleTexture2D_4268274b97974a278c5368845b799a90_B_6 = _SampleTexture2D_4268274b97974a278c5368845b799a90_RGBA_0.b;
            float _SampleTexture2D_4268274b97974a278c5368845b799a90_A_7 = _SampleTexture2D_4268274b97974a278c5368845b799a90_RGBA_0.a;
            surface.Alpha = _SampleTexture2D_4268274b97974a278c5368845b799a90_A_7;
            return surface;
        }
        ...
        SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
        {
            ...
            float _SampleTexture2D_4268274b97974a278c5368845b799a90_B_6 = _SampleTexture2D_4268274b97974a278c5368845b799a90_RGBA_0.b;
            float _SampleTexture2D_4268274b97974a278c5368845b799a90_A_7 = _SampleTexture2D_4268274b97974a278c5368845b799a90_RGBA_0.a;
            surface.BaseColor = (_SampleTexture2D_4268274b97974a278c5368845b799a90_RGBA_0.xyz);
        ...
        void BuildSurfaceData(FragInputs fragInputs, inout SurfaceDescription surfaceDescription, float3 V, PositionInputs posInput, out SurfaceData surfaceData)
        {
            ...
            #include "TransparentShaderPassForwardUnlit.hlsl"
      ...
      //          "LightMode" = "ForwardOnly"
            ...
            Cull [_CullModeForward]
     //   Blend [_SrcBlend] [_DstBlend], [_AlphaSrcBlend] [_AlphaDstBlend]
        Blend Zero One, [_AlphaSrcBlend] [_AlphaDstBlend]
        ZTest [_ZTestDepthEqualForOpaque]
        ZWrite [_ZWrite]
        ColorMask [_ColorMaskTransparentVel] 1
        Stencil
...
//            #endif
        ...
        float _BlendMode;
        float _EnableBlendModePreserveSpecularLighting;
		float _MotionVectorAlphaCutoff;
        CBUFFER_END
        ...
        void BuildSurfaceData(FragInputs fragInputs, inout SurfaceDescription surfaceDescription, float3 V, PositionInputs posInput, out SurfaceData surfaceData)
        {
            ...
            void GetSurfaceAndBuiltinData(FragInputs fragInputs, float3 V, inout PositionInputs posInput, out SurfaceData surfaceData, out BuiltinData builtinData RAY_TRACING_OPTIONAL_PARAMETERS)
            {
                ...
                // TODO: split graph evaluation to grab just alpha dependencies first? tricky..
                    ...
                    GENERIC_ALPHA_TEST(surfaceDescription.Alpha, alphaCutoff);
                #endif
                    GENERIC_ALPHA_TEST(surfaceDescription.Alpha, _MotionVectorAlphaCutoff);
