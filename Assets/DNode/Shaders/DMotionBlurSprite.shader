Shader "New Shader Graph"
    {
        Properties
        {
            _ExtraMotion("Vector4", Vector) = (0, 0, 0.5, 0)
            ...
            [HideInInspector][ToggleUI]_AlphaToMask("Boolean", Float) = 1
            [HideInInspector][ToggleUI]_AlphaToMaskInspectorValue("Boolean", Float) = 1
        ...
        SubShader
        {
            ...
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/ShaderLibrary/ShaderGraphFunctions.hlsl"
                ...
                SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
                {
                    ...
                    UnityTexture2D _Property_c7184846569c43ab934935b5c9769856_Out_0 = UnityBuildTexture2DStructNoScale(_Texture2D);
                    float4 _SampleTexture2D_f8b110823ee943e1adcd2303a5688a1d_RGBA_0 = SAMPLE_TEXTURE2D(_Property_c7184846569c43ab934935b5c9769856_Out_0.tex, _Property_c7184846569c43ab934935b5c9769856_Out_0.samplerstate, _Property_c7184846569c43ab934935b5c9769856_Out_0.GetTransformedUV(IN.uv0.xy));
                    float _SampleTexture2D_f8b110823ee943e1adcd2303a5688a1d_R_4 = _SampleTexture2D_f8b110823ee943e1adcd2303a5688a1d_RGBA_0.r;
                    float _SampleTexture2D_f8b110823ee943e1adcd2303a5688a1d_G_5 = _SampleTexture2D_f8b110823ee943e1adcd2303a5688a1d_RGBA_0.g;
                    float _SampleTexture2D_f8b110823ee943e1adcd2303a5688a1d_B_6 = _SampleTexture2D_f8b110823ee943e1adcd2303a5688a1d_RGBA_0.b;
        ...
        Blend Zero One, [_AlphaSrcBlend] [_AlphaDstBlend]
            ...
            void BuildSurfaceData(FragInputs fragInputs, inout SurfaceDescription surfaceDescription, float3 V, PositionInputs posInput, out SurfaceData surfaceData)
                ...
                #include "DMotionBlurSpriteForwardUnlit.hlsl"
