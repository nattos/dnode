  ...
  public static class StandardOperators {
    ...
    static StandardOperators() {
      All = new[] {
          ...
          new StandardOperator(StandardOperatorType.Equal, codeEmitter: StandardOperatorCodeEmitter.MakeChainedFunction("equal_op", "to_bool"), fixedOutputType: PrimitiveType.Bool),
