...
namespace NanoGraph.VisualScripting {
  public class GraphWindow : LudiqEditorWindow, ICanvasWindow {
    private static readonly string defaultTitle = "Nano Graph";

    private GUIEvent e => GUIEvent.current;

    [MenuItem("Do/Show Graph Window")]
    ...
    private static void CheckForActiveContextChange() {
      ...
      // Sigh. Forward this invocation to the original GraphWindow. GraphClipboard relies on this.
      {
        ...
        System.Reflection.FieldInfo eventField = type.GetField("activeContextChanged", System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.NonPublic);
        MulticastDelegate multicastDelegate = eventField.GetValue(null) as MulticastDelegate;
        if (multicastDelegate != null) {
          Delegate[] invocationList = multicastDelegate.GetInvocationList();
          foreach (Delegate invocationMethod in invocationList) {
            invocationMethod.DynamicInvoke(new[] { activeContext });
          }
        }
      }
    }
    ...
    protected override void Update() {
      ...
      Repaint();
      GraphInspectorWindow.Instance?.Repaint();
    }
    ...
    protected override void OnGUI() {
      ...
      if (context != null) {
        ...
        context.graph.zoom = GUILayout.HorizontalSlider(context.graph.zoom, GraphGUI.MinZoom, 2.0f /*GraphGUI.MaxZoom*/, GUILayout.Width(100));
